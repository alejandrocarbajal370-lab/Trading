...
class NextBlockScope(StrEnum):
    READ_ONLY_REAL_SESSION_PROVISIONING_EVIDENCE = "READ_ONLY_REAL_SESSION_PROVISIONING_EVIDENCE"
    AUTHENTIC_MARKET_DATA_ENTITLEMENT_EVIDENCE = "AUTHENTIC_MARKET_DATA_ENTITLEMENT_EVIDENCE"
    CONNECTIVITY_MARKET_MODE_ENTITLEMENT_SEPARATION = "CONNECTIVITY_MARKET_MODE_ENTITLEMENT_SEPARATION"
    OPAQUE_DIGEST_ONLY_SECRET_BOUNDARY = "OPAQUE_DIGEST_ONLY_SECRET_BOUNDARY"
    EXACT_PROVIDER_ADAPTER_DATASET_ROUTE_REQUEST_SECURITY_SESSION_BINDING = "EXACT_PROVIDER_ADAPTER_DATASET_ROUTE_REQUEST_SECURITY_SESSION_BINDING"
    UTC_LIFECYCLE_REVOCATION_FAIL_CLOSED = "UTC_LIFECYCLE_REVOCATION_FAIL_CLOSED"
    CONTRACT_ONLY_WITHOUT_REAL_VERIFIER = "CONTRACT_ONLY_WITHOUT_REAL_VERIFIER"
...
NEXT_BLOCK = NextBlockAuthorization(
    current_block=RoadmapBlock.GOVERNED_SUFFICIENT_OBSERVATION_POLICY_PROVIDER_ADMISSION_EVIDENCE_AGGREGATION_FOUNDATION,
    name=RoadmapBlock.IBKR_REAL_PROVISIONING_AUTHENTIC_ENTITLEMENT_EVIDENCE_FOUNDATION,
...
AFTER_NEXT_BLOCK = AfterNextBlockCandidate(
    after=RoadmapBlock.IBKR_REAL_PROVISIONING_AUTHENTIC_ENTITLEMENT_EVIDENCE_FOUNDATION,
    name="UNDETERMINED",

...
class NextBlockScope(StrEnum):
    VERSIONED_SUFFICIENT_OBSERVATION_POLICY = "VERSIONED_SUFFICIENT_OBSERVATION_POLICY"
    DISTINCT_OBSERVATION_REPLAY_DEFENSE = "DISTINCT_OBSERVATION_REPLAY_DEFENSE"
    EXACT_PROVIDER_ADAPTER_DATASET_SECURITY_REQUEST_ROUTE_BINDING = (
        "EXACT_PROVIDER_ADAPTER_DATASET_SECURITY_REQUEST_ROUTE_BINDING"
    )
    AUTHENTICITY_PROVISIONING_ENTITLEMENT_LINEAGE_BINDING = (
        "AUTHENTICITY_PROVISIONING_ENTITLEMENT_LINEAGE_BINDING"
    )
    TEN_GATE_EVIDENCE_AGGREGATION = "TEN_GATE_EVIDENCE_AGGREGATION"
    VERIFIER_TIME_LIFECYCLE_AND_REVOCATION = "VERIFIER_TIME_LIFECYCLE_AND_REVOCATION"
    POLICY_AUTHORITY_AND_REVOCATION_OWNER_BINDING = (
        "POLICY_AUTHORITY_AND_REVOCATION_OWNER_BINDING"
    )
    CANONICAL_REPLAY_CUSTODY_WORM_LEGAL_BINDING = (
        "CANONICAL_REPLAY_CUSTODY_WORM_LEGAL_BINDING"
    )
    GATE_SPECIFIC_EVIDENCE_APPLICABILITY = "GATE_SPECIFIC_EVIDENCE_APPLICABILITY"
    EXPLICIT_AGGREGATION_TEMPORAL_CAUSALITY = "EXPLICIT_AGGREGATION_TEMPORAL_CAUSALITY"
    CONTRACT_ONLY_FAIL_CLOSED_ADMISSION = "CONTRACT_ONLY_FAIL_CLOSED_ADMISSION"
...
NEXT_BLOCK = NextBlockAuthorization(
    current_block=RoadmapBlock.EXTERNAL_TRUST_BACKEND_PROVISIONING_CONTRACT_FOUNDATION,
    name=RoadmapBlock.GOVERNED_SUFFICIENT_OBSERVATION_POLICY_PROVIDER_ADMISSION_EVIDENCE_AGGREGATION_FOUNDATION,
...
AFTER_NEXT_BLOCK = AfterNextBlockCandidate(
    after=RoadmapBlock.GOVERNED_SUFFICIENT_OBSERVATION_POLICY_PROVIDER_ADMISSION_EVIDENCE_AGGREGATION_FOUNDATION,
    name="UNDETERMINED",

...
`CONTRACT_TEST_ONLY`; module provenance prevents a caller-supplied transport from claiming the
sealed REAL-local route. Automatic account-list callbacks are discarded before logging or storage.
...
volume, zero tick, or realtime claim.
